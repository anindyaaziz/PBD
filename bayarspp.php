                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-xxs font-weight-bolder opacity-7">Tagihan</th>
                 ...
                 <tbody>
                    ...
                    <?php
                     ...
                     $id = $data_pembayaran['id_jenis']; 
                     $cek = mysqli_query($db, "SELECT * FROM pembayaran_copy  WHERE id_jenis = $id AND noinduk_siswa ='".$_SESSION['username']."'");
                    ?>
                    <tr>
                      ...
                      <?php echo $data_pembayaran['id_jenis'];  ?> 
                     </span>
                    </td>

                      <td class="align-middle text-center text-sm">
                        <span class="text-s font-weight-bold mb-0">
                        <?php echo $data_pembayaran['nama_jenis'];  ?> 
                        </span>
                      </td>
                      ...
                      <?php if(mysqli_num_rows($cek)>0){
                        ?>
                               <a  class="btn" style="background-color:grey;color:white;">PAID</a>
                       <?php
                              }else{
                          ?>
                          <a href="bayar.php?id=<?php echo $data_pembayaran['id_jenis']; ?>" class="btn" style="background-color: green;color:white;">PAY</a>
